...
public class MenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listMenu.add(new ListMenuModel(R.drawable.updatein, "Cập nhật thông tin"));
        listMenu.add(new ListMenuModel(R.drawable.savear, "Kho lưu trữ"));
        listMenu.add(new ListMenuModel(R.drawable.updatepass, "Cập nhật mật khẩu"));
        ...
        lvMenu.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if(selectedItem.getTitle().equals("Cập nhật thông tin")) {
                FragmentManager fragmentManager = getParentFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            ...
            if(selectedItem.getTitle().equals("Cập nhật mật khẩu")) {
                FragmentManager fragmentManager = getParentFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            ...
            if(selectedItem.getTitle().equals("Kho lưu trữ")) {
                FragmentManager fragmentManager = getParentFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
